...
@Service
@Profile("queue-2")
public class SensorDataProcessorQueue2 {

    private static final String SENSOR_DATA_QUEUE_NAME_2 = "sensor-data-2";
    private final InfluxManager influxManager;

    public SensorDataProcessorQueue2(
    ...
    @RabbitListener(queues = SENSOR_DATA_QUEUE_NAME_2)
    public void receiveSensorDataQueue2(SensorData sensorData) {
